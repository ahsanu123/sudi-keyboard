...
// <o> BLE_HRS_C_RR_INTERVALS_MAX_CNT - Maximum number of RR_INTERVALS per
// notification to be decoded
...
// <e> PERIPHERAL_RESOURCE_SHARING_ENABLED - nrf_drv_common - Peripheral drivers
// common module
//==========================================================
...
// store data and <i> one page to be used by the system for garbage collection.
// The total amount <i> of flash memory that is used by FDS amounts to @ref
// FDS_VIRTUAL_PAGES <i> @ref FDS_VIRTUAL_PAGE_SIZE * 4 bytes.
...
// page. <256=> 256 <512=> 512 <1024=> 1024
...
// operations <i> to complete. In general, increase the queue size if you
// frequently receive <i> @ref FS_ERR_QUEUE_FULL errors when calling @ref
// fs_store or @ref fs_erase.
...
// SoftDevice fails. <i> Increase this value if events return the @ref
// FS_ERR_OPERATION_TIMEOUT <i> error often. The SoftDevice may fail to schedule
// flash access due to high BLE activity.
...
// in a single operation. <i> Tweaking this value can increase the chances of
// the SoftDevice being <i> able to fit flash operations in between radio
// activity. This value is bound by the <i> maximum number of words which the
// SoftDevice can write to flash in a single call to <i> @ref sd_flash_write,
// which is 256 words for nRF51 ICs and 1024 words for nRF52 ICs.
...
// string <i> Logger backend RAM usage is determined by this value.
